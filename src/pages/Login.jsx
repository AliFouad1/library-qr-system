...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 relative overflow-hidden">
      ...
      <div className="max-w-md w-full bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-10 m-4 transform hover:scale-105 transition-transform duration-300">
        {/* Logo and Title */}
        <div className="text-center mb-8">
          <div className="inline-block p-4 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl shadow-lg mb-4 transform hover:rotate-6 transition-transform duration-300">
            <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
            </svg>
          </div>
          <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-2">Library System</h1>
          <p className="text-gray-600 font-medium">QR Code Based Management</p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t-2 border-gray-100">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between bg-gradient-to-r from-blue-50 to-indigo-50 p-3 rounded-lg hover:shadow-md transition-shadow">
              <span className="font-bold text-blue-700">Admin:</span>
              <span className="text-gray-700">admin@library.local / admin123</span>
            </div>
            <div className="flex justify-between bg-gradient-to-r from-green-50 to-teal-50 p-3 rounded-lg hover:shadow-md transition-shadow">
              <span className="font-bold text-green-700">Staff:</span>
              <span className="text-gray-700">staff@library.local / staff123</span>
            </div>
            <div className="flex justify-between bg-gradient-to-r from-purple-50 to-pink-50 p-3 rounded-lg hover:shadow-md transition-shadow">
